...
@NamedQueries({
    ...
    ,
    @NamedQuery(name = "MatriculaComponenteEducativo.findComponentePlanificado", query = "select c FROM MatriculaComponenteEducativo c where c.componenteEducativoPlanificado=?1")
})
@Audited
